	...
	public function actionSave()
	{
		...
		else
		{
			...
			if ( isset( $_POST ['notificationEvent'] ) )
			{
				...
				// since this is a notification, we'll make an event/entries association...
			...
			{
				case 'info' :
					$this->redirect( 'sproutemail/settings/notifications/edit/' . $campaignModel->id . '/template' );
					break;

				case 'template' :
				
					$this->redirect( 'sproutemail/settings/notifications/edit/' . $campaignModel->id . '/recipients' );
					break;
